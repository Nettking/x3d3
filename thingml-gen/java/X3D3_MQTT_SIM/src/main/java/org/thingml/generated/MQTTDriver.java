...
Transition h1710441966 = new Transition();
h1710441966.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1710441966.event(temperatureType);
h1710441966.port(MQTT_port);
h1710441966.action((Event e)->{
...
Transition h1253250998 = new Transition();
h1253250998.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1253250998.event(add_thermometerType);
h1253250998.port(require_val_port);
h1253250998.action((Event e)->{
...
Transition h747184469 = new Transition();
h747184469.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h747184469.event(add_lightsensorType);
h747184469.port(require_val_port);
h747184469.action((Event e)->{
...
Transition h1342351974 = new Transition();
h1342351974.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1342351974.event(luminanceType);
h1342351974.port(MQTT_port);
h1342351974.action((Event e)->{
...
Transition h1317734232 = new Transition();
h1317734232.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1317734232.event(add_deviceType);
h1317734232.port(require_val_port);
h1317734232.action((Event e)->{
...
Transition h17669034 = new Transition();
h17669034.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h17669034.event(SwitchOnType);
h17669034.port(require_val_port);
h17669034.action((Event e)->{
...
Transition h600821066 = new Transition();
h600821066.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h600821066.event(SwitchOffType);
h600821066.port(require_val_port);
h600821066.action((Event e)->{
