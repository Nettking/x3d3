...
Handler h982891593 = new Handler();
h982891593.from(state_TimerJava_SoftTimer_default);
h982891593.event(timer_startType);
h982891593.guard((Event e)->{
...
h982891593.port(timer_port);
h982891593.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
